...
const Home = () => {
    return (
        <div className='container mt-5 mb-5 p-3 pt-0'>
            <div className='shadow mb-5 p-5 border rounded text-center'>
            ...
            <div className='shadow mt-5 mb-3 p-5 border rounded text-center '>
                ...
                <div className='text-center'>
                    <Button variant="outline-warning" ><Link to='/courses' className='text-dark text-decoration-none mt-2'>Enroll Now</Link></Button>
                </div>
